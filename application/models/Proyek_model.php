...
class Proyek_model extends CI_Model {
    ...
    public function __construct() {
        parent::__construct();
        $this->api_url = rtrim('http://localhost:8080/proyek', '/'); // Menghindari trailing slash
    }
    ...
    private function send_request($method, $url, $data = null) {
        ...
        $response = @file_get_contents($url, false, $context); // Menggunakan @ untuk menangani error
    ...
    public function get_by_id($id) {
        return $this->send_request('GET', "{$this->api_url}/{$id}"); // Mengembalikan data proyek berdasarkan ID
    }
